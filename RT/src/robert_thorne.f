...
c    &        chm,cbar,bot,bbar,glu,phot)
        CALL FPDFXQ(iqnset,xy,q2,PDFSF,inull)
          glu=pdfSF(0)
          upv=pdfSF(2)-pdfSF(-2)
          dnv=pdfSF(1)-pdfSF(-1)
          usea=pdfSF(-2)
...
c     &        chm,cbar,bot,bbar,glu,phot)
        CALL FPDFXQ(iqnset,xcmup,q2,PDFSF,inull)
          glu=pdfSF(0)
          upv=pdfSF(2)-pdfSF(-2)
          dnv=pdfSF(1)-pdfSF(-1)
          usea=pdfSF(-2)
...
C     &        chm,cbar,bot,bbar,glu,phot)
        CALL FPDFXQ(iqnset,xy,q2f,PDFSF,inull)
          glu=pdfSF(0)
          upv=pdfSF(2)-pdfSF(-2)
          dnv=pdfSF(1)-pdfSF(-1)
          usea=pdfSF(-2)
...
C     &        chm,cbar,bot,bbar,glu,phot)
        CALL FPDFXQ(iqnset,xbmup,q2,PDFSF,inull)
          glu=pdfSF(0)
          upv=pdfSF(2)-pdfSF(-2)
          dnv=pdfSF(1)-pdfSF(-1)
          usea=pdfSF(-2)
