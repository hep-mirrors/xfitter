...
/**
  @class SU3_PositivePion_gluonPdfDecomposition 
  ...
  */
namespace xfitter{
class SU3_PositivePion_gluonPdfDecomposition:public BasePdfDecomposition{
  public:
    SU3_PositivePion_gluonPdfDecomposition(const char*name);
