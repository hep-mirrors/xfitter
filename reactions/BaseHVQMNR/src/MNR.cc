...
namespace MNR
{
  ...
  MNR::MNR(ReactionBaseHVQMNR* ptrReactionTheory)
  {
    //printf("OZ MNR::MNR()\n");
  ...
  void MNR::SetScaleCoef(double mf_a, double mf_b, double mf_c, double mr_a, double mr_b, double mr_c)
  {
    ...
    {
      std::string str = "F: ERROR in MNR::SetScaleCoef(): some parameters are nan. Make sure that you provide all needed parameters in steering.txt (ExtraMinimisationParameters)\n";
