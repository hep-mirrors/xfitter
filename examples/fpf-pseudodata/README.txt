...
Illustrates also:
- using the PineAPPL reaction interface
- rescaling the PDF eigenvectors in parameters.yaml, corresponding to passing a non-1 Delta chi^2 criterion

All the required commands can be executed by running the script runAll.sh.
