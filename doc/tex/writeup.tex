...
(PDFs) using deep inelastic scattering (DIS) data and other processes. 
...
The manulal begins with a brief discussion of the theoretical calculation
...
section~\ref{sec:install}. A description of the program steering cards and
...
%For the DIS processes, the inclusive structure
...
systematic uncertainties are available as described in appendix~\ref{sec:h1fitter}.
