...
or covariance matrix method. In addition, \fitter allows to study different statistics 
...
In addition to PDF display, plots which compare the input data to the fitted theory predictions
to demonstrate the fit consistency can be produced using tools supplied with the package.
\begin{figure}[!ht]
   \centering
