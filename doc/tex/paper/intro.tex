...
This paper describes the open-source QCD fit framework \fitter, which includes a set of tools to facilitate global 
...
of the package are persented in Sec.~\ref{sec:examples}, which is followed by a summary in Sec.~\ref{sec:summary}.
%
