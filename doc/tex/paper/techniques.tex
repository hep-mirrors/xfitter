...
%table in dependence of 
  ...
  This procedure, however, neglects the fact that the $k$-factors can be 
  PDF dependent, 
...
%    The interface to the \fastnlo tables from within \fitter was used in a
...
%both \applgrid for NLO calculations  and the $k$-factor approach for correction to NNLO 
    is displayed in
