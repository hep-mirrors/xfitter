...
This method was used by the ATLAS collaboration in determining the strange quark density of the proton from  
$W$ and $Z$ cross sections \cite{atlas:strange}. An illustration of ATLAS PDF extracted using $k-factor$
method is illustrated in Fig.~\ref{fig:atlas}, shown in comparison with global PDF sets such as CT10\cite{CT10pdf} and NNPDF2.3\cite{NNPDFpdf}.
