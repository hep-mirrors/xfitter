...
A careful consideration must be taken when assigning PDF freedom via functional forms.
...
The choice of functional form can lead to different shape in PDF distributions and consequently the size of the PDF uncertainties can depend on the the flexibility of the parametric choice. 
