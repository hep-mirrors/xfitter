...
$(1 + \epsilon_j \sqrt{x} + D_j x + E_j x^2)$
...
Bayesian Reweighting was first proposed for the PDF sets delivered in form of MC replicas ensembles by~\cite{Giele:1998gw} and further developed by the NNPDF Collaboration~\cite{Ball:2011gg,Ball:2010gb}. 
