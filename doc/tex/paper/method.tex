...
in contrast to polynomial form, is positive by constraction.
...
\end{eqnarray}
where the experimental uncertainties are given in a form of covariance matrix $C_{i,k}$ for measurements in bins $i$ an $k$.
