...
\textcolor{red}{
Due to different origin than theoretical parameters, the uncertainties on the parametrisation 
in a fit are estimated separately and are included into the standard PDF uncertainty.
}
\fitter provides the
