...
%      \path[->] node[draw, text width=2cm, align=center] at (0,0) (init) {\bf Initialization};
      \path[->] node[draw, text width=2cm, text centered] at (0,0) (init) {\bf Initialization};
      ...
      \path[->] node[draw, below right=0.3cm and -0.7cm of init, text width=4.0cm] (theory) 
      ...
      \path[->] node[draw, below right=0.7cm and -1.7cm of data, text width=4cm] (minuit) 
                    {\begin{center} \vspace{-0.1cm}{\bf PDF fit} 
                      \vspace{-0.2cm}
		     \end{center} 
