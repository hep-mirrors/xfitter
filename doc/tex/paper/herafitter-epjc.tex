...
\institute{Version 0.2 (svn 1365)
...
Based on the concept of factorisable nature of the cross sections into universal 
parton distribution functions (PDFs) and process dependent partonic scattering 
cross sections, \fitter allows determination of PDFs from the various hard scattering measurements.
