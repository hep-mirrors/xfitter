...
Based on the concept of the factorisable nature of the cross sections into universal 
Parton Distribution Functions (PDFs) and process dependent partonic scattering 
cross sections, \fitter~ allows determination of PDFs from various hard scattering measurements.
...
are Deep-Inelastic-Scattering  
in $ep$ collisions at HERA and Drell Yan, jet and top quark production in 
$pp$ ($p\bar{p}$) collisions at the LHC (Tevatron).~\fitter~ provides a 
 comprehensive choice in the treatment of the experimental uncertainties. 
...
and funding by the Helmholtz Alliance "Physics at the Terascale".
We are grateful to the DESY IT department for their support of the \fitter\  developers.
We also would like to thank R. Thorne for fruitful discussions.
