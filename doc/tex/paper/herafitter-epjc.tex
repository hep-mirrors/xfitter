...
which provides a framework for QCD analyses related 
to the proton structure in the context of multi-processes and multi-experiments.
Utilising QCD factorisation, \fitter allows determining 
the proton parton distribution functions (PDF) from various hard scattering measurements
...
PDFs. The main processes and data sets that are currently included
...
available in \fitter via interfaces to different modules.
