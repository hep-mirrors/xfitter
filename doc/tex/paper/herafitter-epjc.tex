...
%
Those are complemented with a variety of theoretical options for calculating PDF-dependent cross section predictions corresponding to the measurements.
%
...
%
The package can be used to study the impact of new precise measurements from LHC or elsewhere.
%
