...
together with its supporting documentation. A README file is provided within the package together with fast grid theory files (described in \ref{sec:techniques}) which are associated with the properly formatted data files availabe in \fitter.
...
(using 'FAST' techniques as described in  \ref{sec:techniques}) to several hours when full uncertainties are estimated. The \fitter code is a combination of C++ and Fortran 77 libraries with minimal 
