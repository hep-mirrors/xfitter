...
\item
In the Zero-Mass Variable Flavour Number (ZM-VFN) scheme\cite{bla} the
...
{\bf olaf remark: I find the following paragraph information on the CTEQ scheme a bit difficult 
to digest/appreciate.} 
