...
%  \nonumber
%    \begin{array}{rll}
   \frac{d^2\sigma_{CC}^{e^{\pm} p}}{dxdQ^2}&=&\frac{1\pm P}{2}\frac{G^2_F}{2\pi x} \ \frac{m^2_W}{m^2_W+Q^2} \ \sigma_{r,CC}^{e^{\pm} p}\\
...
corrections. 
%corrections ~\cite{SMoch:npb864,Bierenbaum:2009mv}. 
}
...
\textcolor{red}{In this scheme (see \cite{Thorne:2008xf} for a comprehensive review)}, heavy quark production is treated for
