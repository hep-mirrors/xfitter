...
the agreement between experimental data and corresponding theory models within the DGLAP formalism.
...
In $pp$ scattering, as measured at the LHC, the $Z/\gamma\*$
$W$ production probe bi-linear combinations of these.
%
...
Therefore, to allow the possibility to include jet-cross section 
...
interfaced to the \fitter , APPLGRID (see~\ref{sec:techniques}) and 
FastNLO.
