...
the photon propagator and a helicity factor are absorbed in the definition of the reduced cross section $\sigma_r$.
...
treatment of heavy quark (charm and beauty) production and the chosen values of their masses become important. 
...
Beyond LO, the calculations can no longer be done quickly and Monte Carlo techniques (see section \ref{sec:experimentalerrors}) are often employed. 
