...
Presently, the predictions for DY and $W$ and $Z$ production are available
...
provides easy means to apply kinematic cuts to theoy predictions to emulate
data.
...
for single-top production are available only at NLO accuracy using MCFM package as above.
