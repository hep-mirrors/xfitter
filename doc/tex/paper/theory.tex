...
Deep inelastic scattering (DIS) is the lepton scattering on the 
...
%%%%
\subsubsection{GM-VFN ACOT scheme}
...
%A short description of both implementations is 
...
%The reasons are the large number of contributing
