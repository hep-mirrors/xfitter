...
by a virtual exchange of a NC or CC vector boson and, as a result, a scattered lepton and a 
...
\begin{eqnarray}
%  \nonumber
   \frac{d^2\sigma_{NC}^{e^{\pm} p}}{dxdQ^2}&=&\frac{2\pi\alpha^2}{xQ^4} \sigma_{r,NC}^{e^{\pm} p},\\ 
...
and $F^Z_{2,3}$, which are associated to pure photon exchange terms, photon-$Z$ interference
...
and $F_L$ vanishes. At higher orders, terms related to the gluon density distribution
...
In this scheme \cite{Laenen:1992, Laenen:1993, Riem:1995}, only the gluon and the light quarks are considered
