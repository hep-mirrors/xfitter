...
The dipole models are valid in the low-$x$ region only, where the valence quark contribution is
5\% to 15\% for $x$ from 0.0001 to 0.01 \cite{Collaboration:2010ry}.
%, of the order of 5\%. 
The new HERA $F_2$ measurements have a precision which is  better than 2$\%$. Therefore, in \fitter the contribution of the valence quarks can be taken from the PDF fits and added to the original 
