...
are provided with the \fitter package with the full information on their uncorrelated and correlated
...
\begin{figure}[!ht]
   ...
   of $Q^2=10 \ \GeV^2$ for the HERAPDF1.0 PDF set at Next-to-Leading-Order~\cite{h1zeus:2009wt}.}
 \label{fig:hera1}
\end{figure}
