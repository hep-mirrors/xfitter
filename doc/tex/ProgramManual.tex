...
\item \tt{TheoryType = 'DGLAP' }\rm as used for collinear evolution theories. For this type,
 it follows with another flag which sets the order of perturbative series in $\alpha_S$:
...
The fifth column sets the lower boundary of the fit parameter, 
...
\end{verbatim}
  ...
  pull between the  data and theory and 
