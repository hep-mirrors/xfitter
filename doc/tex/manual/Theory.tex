 ...
 \begin{enumerate}
  ...
  \item[$\bullet$] the ACOT scheme with its variants at LO and NLO as
    ...
    \item the FONLL scheme at NLO and NNLO~\cite{Forte:2010ta}
      provided by the external code {\tt APFEL}~\cite{Bertone:2013vaa},
...
the {\tt APFEL} code~\cite{Bertone:2013vaa}.
...
The perturbative 
coefficients for jet-production in NLO are calculated by the \texttt{NLOJET++}
