...
C RT parameters:
      ...
      PARAMETER (NQGRID=137)
      PARAMETER (NXGRID=5)
      
c      PARAMETER (NQGRID=11)
      double precision  QARR(NQGRID),WGT(NQGRID)
      data iosp/2/                   !x grid, lin/qua/spli

c      DATA WGT/1.d0,  1.d0,  1.d0,  1.d0, 1.d0,
c     $     1.d0, 1.d0, 2.d0, 2.d0, 1.d0, 2.d0/
c      DATA QARR/1., 1.1, 1.2,1.6, 1.8, 1.9,
c     $     1.96,2.89,22.5625,30625.,500000000./



      DATA WGT/2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 
     ...
     $         2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 
     $         2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,2.d0, 
     $         2.d0, 2.d0,2.d0,2.d0, 2.d0,2.d0,4.d0, 4.d0,4.d0,4.d0, 
     $         4.d0, 4.d0,4.d0,4.d0, 4.d0,4.d0,4.d0, 4.d0/


      DATA QARR/ 1.000, 1.020, 1.040, 1.060, 1.080, 1.100, 1.120,
     ...
     $           1.560, 1.580, 1.600, 1.620, 1.640, 1.660, 1.680,
     $           1.700, 1.720, 1.740, 1.760, 1.780, 1.800, 1.8225,
     $           1.860, 1.880, 1.900, 1.920, 1.940, 1.960,
     $           1.980, 2.000, 2.020, 2.040, 2.060, 2.080, 2.100,
     $           2.120, 2.140, 2.160, 2.180, 2.200, 2.220, 
     $           2.250, 2.280, 2.300, 2.320, 2.340, 2.360, 2.380,
     $           2.400, 2.420, 2.440, 2.460, 2.480, 2.500, 2.520,
     $           2.540, 2.560, 2.580, 2.600, 2.620, 2.640, 2.660,
     $           2.680, 2.700, 2.7225, 2.760, 2.780, 2.800,
     $           2.820, 2.840, 2.860, 2.880, 2.900, 2.920, 2.940,
     $           2.960, 2.980, 3.000, 3.020, 3.040, 3.060, 3.080,
     $           3.100, 3.120, 3.140, 3.160, 3.180, 3.200, 3.220,
     $           3.240, 3.260, 3.280, 3.300, 3.320, 3.340, 3.360,
     $           3.380, 3.400, 3.420, 3.440, 3.460, 3.480, 3.500,
     $           4.000, 6.5,   12.00,   18.49, 20.25, 25.00, 35.,
     $           60., 120., 200., 400., 1000., 30625., 100000./
