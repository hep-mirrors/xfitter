...
if len(sys.argv)<2:
  print '''Usage: AddPdfParam.py NAME
...
formatDict={"name":name,"classname":classname,"date":datetime.date.today().isoformat()}
...
with open(hFile,"w") as f:
  f.write(
    '''//Automatically generated by AddPdfParam.py on {date}
#pragma once
...
class {classname}:public BasePdfParam{{
  public:
    {classname}(const std::string&inName):BasePdfParam(inName){{}}
...
with open(sFile,"w") as f:
  f.write('''//Automatically generated by AddPdfParam.py on {date}
...
with open(aFile,"w") as f:
  f.write('''AM_CXXFLAGS=-I$(srcdir)/../include -I$(srcdir)/../../../include  -I$(srcdir)/../../BasePdfParam/include -Wall -fPIC -Wno-deprecated 
