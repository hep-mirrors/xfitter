...
if(EXISTS "$ENV{yaml_cpp_DIR}")
  ...
  set(ENV{PKG_CONFIG_PATH} "$ENV{yaml_cpp_DIR}/share/pkgconfig:$ENV{yaml_cpp_DIR}/lib64/pkgconfig:$ENV{yaml_cpp_DIR}/pkgconfig:$ENV{yaml_cpp_DIR}:$ENV{PKG_CONFIG_PATH}")
endif()
